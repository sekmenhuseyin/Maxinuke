...
<link rel="stylesheet" type="text/css" href="images/temalar/§default/style.css">
...
End IF
	...
	sayif = ks.fields.count
		Response.Write "<table border=0 cellpadding=2 cellspacing=2 class=td_menu width=300><tr>"
		For i = 0 to sayif-1
...
<tr>
<td>
<textarea name="sql_code" rows="10" class="form1" style="width:100%"><%=Request.Form("sql_code")%></textarea>
</td>
</tr>
<tr>
<td>Database Seçin : 
