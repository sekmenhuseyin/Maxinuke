...
Function Temizle(strInput)
	...
	strInput = Replace(strInput,"ö","o")
	strInput = Replace(strInput,"ç","c")
	strInput=replace(strInput, "&#226;", "â", 1, -1, 1)
	strInput=replace(strInput, "&#199;", "Ç", 1, -1, 1)
	strInput=replace(strInput, "&#231;", "ç", 1, -1, 1)
	strInput=replace(strInput, "&#286;", "Ð", 1, -1, 1)
	strInput=replace(strInput, "&#287;", "ð", 1, -1, 1)
	strInput=replace(strInput, "&#305;", "ý", 1, -1, 1)
	strInput=replace(strInput, "&#304;", "Ý", 1, -1, 1)
	strInput=replace(strInput, "&#214;", "Ö", 1, -1, 1)
	strInput=replace(strInput, "&#246;", "ö", 1, -1, 1)
	strInput=replace(strInput, "&#350;", "Þ", 1, -1, 1)
	strInput=replace(strInput, "&#351;", "þ", 1, -1, 1)
	strInput=replace(strInput, "&#220;", "Ü", 1, -1, 1)
	strInput=replace(strInput, "&#252;", "ü", 1, -1, 1)
